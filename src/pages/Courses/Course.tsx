                    ...
                    <div className='flex space-x-2'>
                        ...
                        <div className='flex-1'>
                            ...
                            <div className='flex-end mt-8 space-x-3'>
                                <button className={clsx('group flexx border border-primary hover:border-transparent rounded-lg py-2 px-4 text-sm text-primary', quizNumber === 1 ? 'cursor-default border-transparent bg-gray-200 hover:bg-gray-200 hover:text-primary' : 'hover:bg-primary hover:text-white')} onClick={handlePrevious}>
